...
export default function BentoGrid() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      ...
      {/* Bento Grid Layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 auto-rows-auto">

        {/* ============================================ */}
        {/* 1. Student Directory Card (Wide — 2 cols, or 4 cols if expanded) */}
        {/* ============================================ */}
        <BentoCard colSpan={2} className="xl:col-span-2" id="siswa">
          ...
          {filteredStudents.length > 12 && (
            ...
            >
              {showAll ? 'Tampilkan Lebih Sedikit' : `Lihat Semua (${filteredStudents.length})`}
            </button>
          )}
        </BentoCard>
        ...
        {/* ============================================ */}
        <BentoCard colSpan={2} className="xl:col-span-2" id="proyek">
          <ProjectShowcase />
        </BentoCard>
        ...
        {/* ============================================ */}
        <BentoCard colSpan={2} className="xl:col-span-2" id="jadwal">
          <ScheduleCard />
        </BentoCard>
